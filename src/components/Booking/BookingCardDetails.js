...
const BookingCardDetails = () => {
  ...
  const adminModal = useSelector(state => state.globalStore.AdminBookingModal);
            ...
            selectedData?.ServiceDates !== undefined ? (
              <TouchableOpacity
                ...
                <Text
                  ...
                  Cleck here to see the details for individual dates{' '}
                </Text>
              </TouchableOpacity>
            ) : loggedInUser.isAdmin &&
          ...
          <Text
            style={[
              styles.parkingLabel,
              {
                ...
                color:
                  selectedData?.Status === 'Completed' ? '#009255' : '#333333',
                alignSelf:
